...
class RocketMqConst {
    ...
    static final String BASE_PRODUCER_CLASSNAME = "com.xixi.rocketmq.springboot.starter.BaseRocketMqProducer";
    static final String BASE_CONSUMER_CLASSNAME = "com.xixi.rocketmq.springboot.starter.BaseRocketMqConsumer";
